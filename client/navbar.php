...
<nav class="navbar fixed-top navbar-expand-lg navbar-light px-5">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto gap-3 d-flex align-items-center">
            ...
            <button class="border-0 p-3 rounded-3" style="background: rgb(19,39,88); background: linear-gradient(313deg, rgba(19,39,88,1) 0%, rgba(0,166,147,1) 100%); color:white;">Map Interaktif <img src="bg/iconMap.png" alt=""></button>
        </ul>
    </div>
</nav>
