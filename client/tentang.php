...
<body style="font-family: 'Plus Jakarta Sans', sans-serif;">
    ...
    <section class="section-penghargaan">
        ...
        <div class="penghargaan1">
            <p>APRESIASI DAN PELATIHAN SERTA KUNJUNGAN <br> TAMU DARI BERBAGAI INSTANSI/LEMBAGA DAN DARI <br> BERBAGAI PIHAK, BAIK BERUPA MATERI MAUPUN <br> PENGAKUAN ADMINISTRATIF</p>
        </div>
        <div class="card-row">
            <div class="card">
